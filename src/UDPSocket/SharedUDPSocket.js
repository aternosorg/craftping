...
export default class SharedUDPSocket extends EventEmitter {
    ...
    constructor(options = {type: "udp4"}, bindOptions = {}) {
        super();
        this.socketOptions = Object.assign({type: "udp4"}, options);
        this.bindOptions = Object.assign({exclusive: true}, bindOptions);
    }
    ...
    /**
     * Unrefs the underlying socket, allowing the process to exit if this is the only active socket.
     *
